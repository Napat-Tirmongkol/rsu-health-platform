    ...
    <div class="max-w-md mx-auto relative min-h-screen">
        ...
        <header
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="<?= lang_switch_url() ?>"
                    class="w-10 h-10 flex items-center justify-center text-slate-500 hover:text-green-600 font-black text-[10px] transition-all">
                    <?= __('lang.switch') ?>
                </a>
        ...
        <main class="px-6 pt-8 space-y-8">
            ...
            <div class="px-1">
                ...
                <div class="flex items-end justify-between">
                    <h2 class="text-3xl font-black text-slate-900 tracking-tight"><?= __('hub.heading') ?></h2>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <button onclick="showUpcoming('ประวัติการเข้าพบ')"
                    ...
                    <p class="text-slate-400 text-[10px] font-bold uppercase tracking-widest"><?= __('hub.service_count') ?></p>
                </button>
                <button onclick="showUpcoming('รายการยืมอุปกรณ์')"
                    ...
                    <p class="text-slate-400 text-[10px] font-bold uppercase tracking-widest"><?= __('hub.borrow_count') ?></p>
                </button>
            </div>
