    ...
    <div class="max-w-md mx-auto relative min-h-screen">
        ...
        <header class="bg-white/80 backdrop-blur-xl sticky top-0 z-[60] px-6 py-4 flex items-center justify-between border-b border-slate-50 shadow-sm shadow-slate-100">
            ...
            <div class="flex items-center gap-3">
                ...
                <button onclick="window.location.href='profile.php'" class="avatar" title="Account">
        ...
        <main class="px-6 pt-8 space-y-8">
            ...
            <div onclick="window.location.href='profile.php'" class="relative overflow-hidden bg-gradient-to-br from-[#0052CC] via-[#0066FF] to-[#0052CC] rounded-[3rem] p-8 shadow-[0_25px_50px_-12px_rgba(0,82,204,0.3)] group active:scale-[0.97] transition-all cursor-pointer">
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div class="bg-white p-4 rounded-2xl border border-slate-100/50 shadow-sm flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-slate-800 font-black text-xs leading-none"><?= date('d M Y', strtotime($b['slot_date'])) ?></p>
                                        </div>
                                    </div>
                                    <div class="bg-white p-4 rounded-2xl border border-slate-100/50 shadow-sm flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-slate-800 font-black text-xs leading-none"><?= date('H:i', strtotime($b['start_time'])) ?> น.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
