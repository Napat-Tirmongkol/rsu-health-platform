<x-portal-layout title="Portal Dashboard">
    <div class="py-10">
        <div class="mx-auto max-w-7xl space-y-8 px-6 lg:px-8">
            ...
            {{-- KPI Dashboard (cross-clinic metrics) --}}
            <section>
                <div class="mb-6">
                    <p class="text-[10px] font-black uppercase tracking-[0.24em] text-slate-400">KPI Overview</p>
                    <h3 class="mt-2 text-2xl font-black tracking-tight text-slate-950">ตัวชี้วัดประสิทธิภาพระบบ</h3>
                </div>
                @livewire('portal.kpi-dashboard')
            </section>
        </div>
    </div>
</x-portal-layout>
