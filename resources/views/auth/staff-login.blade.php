<x-guest-layout>
    <x-authentication-card>
        ...
        <div class="mb-6 text-center">
            <h1 class="text-lg font-semibold text-gray-900">{{ __('Staff Login') }}</h1>
        </div>
        ...
        <form method="POST" action="{{ route('staff.login.store') }}">
            ...
            <div class="mt-4 block">
                <label for="remember_staff" class="flex items-center">
                    <x-checkbox id="remember_staff" name="remember" />
