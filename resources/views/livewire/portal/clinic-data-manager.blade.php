<div class="space-y-6">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
            <select wire:model.live="selectedClinicId" class="rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm font-bold text-slate-700 shadow-sm focus:border-sky-400 focus:outline-none focus:ring-4 focus:ring-sky-50">
                <option value="0">— Global (clinic_id = 0) —</option>
            ...
            <div class="relative">
                ...
                <input
                    ...
                    class="w-full rounded-2xl border border-slate-200 bg-white py-3 pl-10 pr-4 text-sm font-bold text-slate-700 shadow-sm focus:border-sky-400 focus:outline-none focus:ring-4 focus:ring-sky-50 sm:w-64"
                >
            </div>
        </div>
        <button
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full whitespace-nowrap text-left">
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="px-6 py-16 text-center text-sm font-bold text-slate-400">ยังไม่มี settings สำหรับคลินิกนี้</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div class="relative w-full max-w-lg rounded-[2rem] bg-white p-8 shadow-2xl">
                <h3 class="text-xl font-black tracking-tight text-slate-900">
                    {{ $editingId ? 'แก้ไข Setting' : 'เพิ่ม Setting ใหม่' }}
                </h3>
    ...
    @if ($showDeleteModal)
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div class="relative w-full max-w-sm rounded-[2rem] bg-white p-8 shadow-2xl">
                ...
                <h3 class="mt-4 text-xl font-black text-slate-900">ยืนยันการลบ Setting</h3>
                <p class="mt-2 text-sm font-bold text-slate-500">การลบนี้ไม่สามารถย้อนกลับได้</p>
